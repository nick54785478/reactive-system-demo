...
INSERT INTO role_info (tenant, name, type, description, active_flag) VALUES ('DEFAULT', 'ADMIN', 'ROOT', '系統管理員', 'Y');
INSERT INTO role_info (tenant, name, type, description, active_flag) VALUES ('DEFAULT', 'DATA_OWNER', 'USER', '新增、修改、刪除、讀取所有使用者、角色資料權限', 'Y');
